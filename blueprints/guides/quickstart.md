• I had to run it via Docker + Flutter web because your local machine wasn’t ready for a pure local backend run (psycopg missing,
  no local Postgres, Docker daemon initially off).
