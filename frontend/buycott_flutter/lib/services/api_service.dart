...
class BuycottApiService {
  ...
  Future<SearchPayload> search({
    ...
    required bool consumerFacingOnly,
    required bool includeServiceAreaBusinesses,
    required bool requireDelivery,
    required bool requireTakeout,
    required bool requireDineIn,
    required bool requireCurbsidePickup,
    ...
    final uri = _buildUri('/api/search', {
      ...
      'consumer_facing_only': consumerFacingOnly.toString(),
      'include_service_area_businesses':
          includeServiceAreaBusinesses.toString(),
      'require_delivery': requireDelivery.toString(),
      'require_takeout': requireTakeout.toString(),
      'require_dine_in': requireDineIn.toString(),
      'require_curbside_pickup': requireCurbsidePickup.toString(),
